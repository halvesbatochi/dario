...
final class DRInstitutionViewViewModel: NSObject {
    ...
    public func fetchInstitution() {
        ...
        let temp1 = DRInstitution(id: 1, name: "Fundação Caramelo", district: "Rebouças", city: "Curitiba", biography: "Fundada em 1985 o Asilo Dona Maria visa ser um lar de idosas onde possam encontrar um ambiente acolhedor e com toda a estrutura e cuidados necessários para essa etapa da vida.\n\nAtualmente desenvolvemos parcerias com Instituições de ensino e com grupos formados por cidadãos com o intuito de promover a integração e colaboração da Instituição com a sociedade.\n\nDiversas atividades são desenvolvidas durante o ano e uma infinidade de oportunidades podem ser aproveitadas para construção de uma sociedade mais solidária.")
        let temp2 = DRInstitution(id: 2, name: "ONG 4Patas", district: "Centro", city: "Curitiba", biography: "Fundada em 1985 o Asilo Dona Maria visa ser um lar de idosas onde possam encontrar um ambiente acolhedor e com toda a estrutura e cuidados necessários para essa etapa da vida.\n\nAtualmente desenvolvemos parcerias com Instituições de ensino e com grupos formados por cidadãos com o intuito de promover a integração e colaboração da Instituição com a sociedade.\n\nDiversas atividades são desenvolvidas durante o ano e uma infinidade de oportunidades podem ser aproveitadas para construção de uma sociedade mais solidária.")
        let temp3 = DRInstitution(id: 3, name: "Céu Vivo", district: "Batel", city: "Curitiba", biography: "Fundada em 1985 o Asilo Dona Maria visa ser um lar de idosas onde possam encontrar um ambiente acolhedor e com toda a estrutura e cuidados necessários para essa etapa da vida.\n\nAtualmente desenvolvemos parcerias com Instituições de ensino e com grupos formados por cidadãos com o intuito de promover a integração e colaboração da Instituição com a sociedade.\n\nDiversas atividades são desenvolvidas durante o ano e uma infinidade de oportunidades podem ser aproveitadas para construção de uma sociedade mais solidária.")
        let temp4 = DRInstitution(id: 4, name: "Pegada Fofinha", district: "Bigorrilho", city: "Curitiba", biography: "Fundada em 1985 o Asilo Dona Maria visa ser um lar de idosas onde possam encontrar um ambiente acolhedor e com toda a estrutura e cuidados necessários para essa etapa da vida.\n\nAtualmente desenvolvemos parcerias com Instituições de ensino e com grupos formados por cidadãos com o intuito de promover a integração e colaboração da Instituição com a sociedade.\n\nDiversas atividades são desenvolvidas durante o ano e uma infinidade de oportunidades podem ser aproveitadas para construção de uma sociedade mais solidária.")
        let temp5 = DRInstitution(id: 5, name: "MST", district: "Água Verde", city: "Curitiba", biography: "Fundada em 1985 o Asilo Dona Maria visa ser um lar de idosas onde possam encontrar um ambiente acolhedor e com toda a estrutura e cuidados necessários para essa etapa da vida.\n\nAtualmente desenvolvemos parcerias com Instituições de ensino e com grupos formados por cidadãos com o intuito de promover a integração e colaboração da Instituição com a sociedade.\n\nDiversas atividades são desenvolvidas durante o ano e uma infinidade de oportunidades podem ser aproveitadas para construção de uma sociedade mais solidária.")
        let temp6 = DRInstitution(id: 6, name: "ONG Rua Solidária", district: "Centro", city: "Curitiba", biography: "Fundada em 1985 o Asilo Dona Maria visa ser um lar de idosas onde possam encontrar um ambiente acolhedor e com toda a estrutura e cuidados necessários para essa etapa da vida.\n\nAtualmente desenvolvemos parcerias com Instituições de ensino e com grupos formados por cidadãos com o intuito de promover a integração e colaboração da Instituição com a sociedade.\n\nDiversas atividades são desenvolvidas durante o ano e uma infinidade de oportunidades podem ser aproveitadas para construção de uma sociedade mais solidária.")
